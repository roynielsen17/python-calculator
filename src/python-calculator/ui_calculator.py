...
"}")
        ...
        self.gridLayout.addWidget(self.btn_1, 6, 0, 1, 1)
        ...
        self.decimal_radioButton = QRadioButton(self.centralwidget)
        self.decimal_radioButton.setObjectName(u"decimal_radioButton")
        palette = QPalette()
        brush = QBrush(QColor(0, 253, 255, 255))
        brush.setStyle(Qt.BrushStyle.SolidPattern)
        palette.setBrush(QPalette.ColorGroup.Active, QPalette.ColorRole.WindowText, brush)
        brush1 = QBrush(QColor(39, 191, 115, 255))
        ...
        self.decimal_radioButton.setPalette(palette)

        self.gridLayout.addWidget(self.decimal_radioButton, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_mul, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_dot, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_0, 7, 0, 1, 2)

        self.octal_radioButton = QRadioButton(self.centralwidget)
        self.octal_radioButton.setObjectName(u"octal_radioButton")
        palette1 = QPalette()
        ...
        self.octal_radioButton.setPalette(palette1)

        self.gridLayout.addWidget(self.octal_radioButton, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_div, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_equal, 6, 3, 2, 1)

        self.hex_radioButton = QRadioButton(self.centralwidget)
        self.hex_radioButton.setObjectName(u"hex_radioButton")
        palette2 = QPalette()
        ...
        self.hex_radioButton.setPalette(palette2)

        self.gridLayout.addWidget(self.hex_radioButton, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_bracket, 3, 1, 1, 1)
        ...
        self.base60_radioButton = QRadioButton(self.centralwidget)
        self.base60_radioButton.setObjectName(u"base60_radioButton")
        palette3 = QPalette()
        ...
        self.base60_radioButton.setPalette(palette3)

        self.gridLayout.addWidget(self.base60_radioButton, 2, 3, 1, 1)

        self.binary_radioButton = QRadioButton(self.centralwidget)
        self.binary_radioButton.setObjectName(u"binary_radioButton")
        palette4 = QPalette()
        ...
        palette4.setBrush(QPalette.ColorGroup.Disabled, QPalette.ColorRole.Highlight, brush1)
        self.binary_radioButton.setPalette(palette4)

        self.gridLayout.addWidget(self.binary_radioButton, 1, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.decimal_radioButton.setText(QCoreApplication.translate("MainWindow", u"Dec", None))
        ...
        self.octal_radioButton.setText(QCoreApplication.translate("MainWindow", u"Oct", None))
        ...
        self.hex_radioButton.setText(QCoreApplication.translate("MainWindow", u"Hex", None))
        self.btn_bracket.setText(QCoreApplication.translate("MainWindow", u"( )", None))
        self.btn_8.setText(QCoreApplication.translate("MainWindow", u"8", None))
        self.base60_radioButton.setText(QCoreApplication.translate("MainWindow", u"sexagesimal", None))
        self.binary_radioButton.setText(QCoreApplication.translate("MainWindow", u" Bin", None))
    # retranslateUi
